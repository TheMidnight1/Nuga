...
@section('content') 
    ...
    <section class="white-bg my-2">
      <div class="product-section row justify-content-center align-items-center  py-4">
        <div class="image-section col12 col-md-6" data-aos="fade-right">
    ...
    <section class="white-bg">
      <div id="new" class="tab-trending-content active row m-0">
        <div class="item col-12 col-md-3" data-aos="fade-up">
          <img src="https://via.placeholder.com/150" alt="New Item 1" />
          <h4>New Item 1</h4>
          <div class="round-btn">View Detail</div>
        </div>
        <div class="item col-12 col-md-3" data-aos="fade-up">
          <img src="https://via.placeholder.com/150" alt="New Item 2" />
          <h4>New Item 2</h4>
          <div class="round-btn">View Detail</div>
        </div>
        <div class="item col-12 col-md-3" data-aos="fade-up">
